...
API = "https://api.coingecko.com/api/v3/simple/price?ids=bitcoin&vs_currencies=usd&include_market_cap=true&include_24hr_vol=true&include_24r_change=true&include_last_update_at=true"
...
def process_bitcoin(ti):
    ...
    processed_data = {"usd": response["usd"], "change": response["usd_24_vol"]}
